...
import SUPPORT_AGENT_IMAGE from "../images/support-agent.png";
import { DefaultLayout } from "../layouts/default";
import { AuthenticationResponse } from "../components";
import { useLocation } from "react-router-dom";
import { LogoutRequestDenied } from "../components/LogoutRequestDenied";
import { CSRUtilsHome } from "../components/CSRUtilsHome";
                ...
                state.isAuthenticated
                    ? (
                        <div className="">
                            ...
                            />
                            <button
                                className="btn primary mt-4 logout"
                                onClick={ () => {
                                    handleLogout();
                                } }
                            >
                    ...
                    : (
                        <div className="content">
                            <div className="home-image">
                                <img src={ SUPPORT_AGENT_IMAGE } height={250}/>
                            </div>
                            <h4 className={ "spa-app-description" }>
                                Welcome to the Staples CSR Utils application!
                            </h4>
                            <button
